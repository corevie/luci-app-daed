...
var configSectionSpecs = []configSectionSpec{
	...
	{name: "ech_tunnel", decode: decodeEchTunnelSection},
}
...
func decodeEchTunnelSection(conf *Config, section *config_parser.Section) error {
	conf.EchTunnel = &EchTunnel{}
	return SectionParser(reflect.ValueOf(conf.EchTunnel), section)
}
